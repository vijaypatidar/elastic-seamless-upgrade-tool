...
class DeprecationServiceTest {
  ...
  void getKibanaDeprecationCounts_returnsCorrectCounts() {
    ...
    // Act
    ClusterInfoResponse.DeprecationCounts counts = deprecationService.getKibanaDeprecationCounts(CLUSTER_ID);
  ...
  void getElasticDeprecationCounts_returnsCorrectCounts() {
    ...
    // Act
    ClusterInfoResponse.DeprecationCounts counts = deprecationService.getElasticDeprecationCounts(CLUSTER_ID);
